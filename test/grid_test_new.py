...
tgrid2 = rtg.variables['theta'][:].data
gbdrift2 = rtg.variables['gbdrift'][:].data
gradpar2 = rtg.variables['gradpar'][:].data
grho2 = rtg.variables['grho'][:].data
cvdrift2 = rtg.variables['cvdrift'][:].data
gds2_2 = rtg.variables['gds2'][:].data
bmag2 = rtg.variables['bmag'][:].data
gds21_2 = rtg.variables['gds21'][:].data
gds22_2 = rtg.variables['gds22'][:].data
cvdrift0_2 =  rtg.variables['cvdrift0'][:].data
gbdrift0_2 = rtg.variables['gbdrift0'][:].data
aplot2 = rtg.variables['aplot'][:].data
aprime2 = rtg.variables['aprime'][:].data
jacob2 = rtg.variables['jacob'][:].data
